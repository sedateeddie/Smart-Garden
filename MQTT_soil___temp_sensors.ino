...
const int AirValue1 = 736;   //you need to replace this value with the value from the sensor in air
const int WaterValue1 = 289;  //you need to replace this value with the value from the sensor in water
...
void loop() {
  ...
  now = millis();
  // Publishes new temperature, humidity & soil moisture every 10 seconds
...
{
sprintf(msg,"%d",soilmoisturepercent1);

 client.publish("room/soil", msg);
